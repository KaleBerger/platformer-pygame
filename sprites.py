...
class Player(pg.sprite.Sprite):
    ...
    def load_images(self):
        self.standing_frames = [self.game.spritesheet.get_image(614, 1063, 120, 191),
                                                         self.game.spritesheet.get_image(690, 406, 120, 191)]
        for frame in self.standing_frames:
            frame.set_colorkey(BLACK)
        self.walk_frames_r = [self.game.spritesheet.get_image(678, 868, 120, 191),
                                                     self.game.spritesheet.get_image(692, 1458, 120, 191)]
        self.walk_frames_l = []
